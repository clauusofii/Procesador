...
st.set_page_config(
    page_title="Demanda Insatisfecha",
    page_icon="📊",
    layout="wide"
)
...
with right:
    ...
    <div class="hero">
        ...
        <div class="hero-subtitle">Fuga involuntaria · Clientes Grandes y Tradicionales · Sector Cecinas</div>
        <div class="hero-text">
...
if archivo is not None:
    try:
        with st.spinner("Procesando reporte..."):
            ...
            df_ty_gc = df_export[
                df_export["T. Cliente"].isin(["Tradicional", "Grandes Clientes"])
            ].copy()
            ...
            with pd.ExcelWriter(salida, engine="openpyxl") as writer:
                ...
                df_ty_gc.to_excel(writer, sheet_name="Clientes Grandes y Trad.", index=False)
        ...
        metricas = [
            ...
            ("👥", len(df_ty_gc), "Registros Clientes Grandes y Tradicionales", "Filtro por tipo de cliente"),
        ...
        with col_a:
            ...
            <div class="card check-list">
                ...
                ✅ Filtrado de Clientes Grandes y Tradicionales<br>
        ...
        with col_b:
            ...
            <div class="card">
                ...
                👥 Clientes Grandes y Tradicionales<br>
